...
//zeigt Balken zum Schauen, wo der Strich sich befindet
...
// Rückwert = true wenn er ein Strich erkennt
bool aboveLine(uint8_t sensorIndex)
{
  return lineSensorValues[sensorIndex] > sensorThreshold;
}

// Rückwert = true wenn er viel Dunkles sieht (Ende)
...
//schaut, ob man auf einem dunklen "Ort" ist
//wenn alle Mittelsensoren drauf sind, heissts dass man
//den Schluss gefunden hat
bool aboveDarkSpot()
{
